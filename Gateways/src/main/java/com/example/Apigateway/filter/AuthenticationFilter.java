	...
	private boolean isAuthorized(String role, String path, String method) {
		if ("MANAGER".equalsIgnoreCase(role)) {
			return path.startsWith("/employees") || path.startsWith("/leave/approve")
					|| path.startsWith("/leave/history") || path.startsWith("/leave/reject")||path.startsWith("/leave/leavescounts")
					...
					|| path.startsWith("/shifts/pendingSwaps") || path.startsWith("/attendance/getmonthlyreport")
					|| path.startsWith("shifts")||path.startsWith("/leave/resetAll");
		} else if ("EMPLOYEE".equalsIgnoreCase(role)) {
			return path.startsWith("/attendance") || path.startsWith("/attendance/clockin")
					|| path.startsWith("/attendance/clockout") || path.startsWith("/leave/apply")
					|| path.startsWith("/leave/balance") || path.startsWith("/leave/history/Pending")
					|| path.startsWith("/leave/delete") || path.startsWith("/attendance/history")
					|| path.startsWith("/shifts/requestSwap")||path.startsWith("/shifts/findById");
		}
		return false;
	}
